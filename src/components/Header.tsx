      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-3" aria-label="YourChildDoc home">
          ...
          <span>
            ...
            <span className="block text-xs font-medium text-slate-500">Pediatric care in Nepal</span>
          </span>
        </Link>
        ...
        <Link href="/contact" className="grid size-11 place-items-center rounded-full border border-sky-100 text-slate-700 lg:hidden" aria-label="Open contact and menu">
